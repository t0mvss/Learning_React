...
console.log(title + " by " + author + " their genres are: " + genres);
...
const summary = `${title} is a ${pages} pages long book, it was written by ${author} and publish in ${
...
console.log("Some thing" && "some com");
